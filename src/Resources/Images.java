...
public class Images {
	...
	public static BufferedImage OverTown;
...
//			
			...
			OverTown = ImageIO.read(getClass().getResourceAsStream("/Worlds/TownMap.png"));
...
//		map[3] = toBufferedImage(Scaledmap[1]);
		...
		ScaledTown = Images.TownMap.getScaledInstance(5850, 4270, Image.SCALE_SMOOTH);
	}
